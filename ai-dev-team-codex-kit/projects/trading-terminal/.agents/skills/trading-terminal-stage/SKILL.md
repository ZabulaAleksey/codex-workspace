---
name: trading-terminal-stage
description: Implement exactly one bounded roadmap stage for Trading Terminal using this project's specialists and verification rules.
---
