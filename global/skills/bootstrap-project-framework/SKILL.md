...
10. Оформляй человекочитаемый контекст на русском языке по умолчанию; не переводи программные идентификаторы, API, команды, пути и машинные ключи.
11. Обнови текущий status и остановись до реализации продукта, если пользователь явно не запросил код.
